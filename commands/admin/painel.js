    ...
    async execute(interaction) {
        ...
        const row = new ActionRowBuilder().addComponents(
            new ButtonBuilder()
                ...
                .setURL(`https://discord.com/api/oauth2/authorize?client_id=${config.oauth2.clientId}&redirect_uri=${encodeURIComponent(config.oauth2.redirectUri)}&response_type=code&scope=identify%20email`)
        );
